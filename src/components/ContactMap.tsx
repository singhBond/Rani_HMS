  ...
  return (
    ...
    <section className="p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center  my-8">
        {/* Telephone Card */}
        <Card className="bg-white w-full sm:min-h-28 sm:min-w-32 grid grid-flow-col justify-center rounded-none shadow-none transition duration-500 transform hover:-translate-y-2 border-none hover:border-b-2 hover:border-b-sky-700 hover:bg-white">
          <Smartphone
            size={48}
            color="#0284c7"
            strokeWidth={1}
